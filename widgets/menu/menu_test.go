...
func TestMenuDraws(t *testing.T) {
	tests := []struct {
		desc         string
		canvas       image.Rectangle
		meta         *widgetapi.Meta
		opts         []Option
		writes       func(*Menu) error
		events       func(*Menu)
		...
		},
		{
			...
			want: func(size image.Point) *faketerm.Terminal {
				...
				testdraw.MustMenu(c, "hello", image.Point{0, 0})
		...
		},
		{
			...
			want: func(size image.Point) *faketerm.Terminal {
				...
				testdraw.MustMenu(c, "你好，世界", image.Point{0, 0})
				testcanvas.MustApply(c, ft)
				return ft
			},
		},
		{
			...
			want: func(size image.Point) *faketerm.Terminal {
				...
				testdraw.MustMenu(c, "hello world", image.Point{0, 0})
				testcanvas.MustApply(c, ft)
				return ft
			},
		},
		{
			...
			want: func(size image.Point) *faketerm.Terminal {
				...
				testdraw.MustMenu(c, "world", image.Point{0, 0})
				testcanvas.MustApply(c, ft)
				return ft
			},
		},
		...
		},
		{
			...
			want: func(size image.Point) *faketerm.Terminal {
				...
				testdraw.MustMenu(c, "hello", image.Point{0, 2})
				testdraw.MustMenu(c, "world", image.Point{0, 4})
				testcanvas.MustApply(c, ft)
				return ft
			},
		},
		{
			...
			want: func(size image.Point) *faketerm.Terminal {
				...
				testdraw.MustMenu(c, "default", image.Point{0, 0})
				testdraw.MustMenu(c, "red", image.Point{0, 1}, draw.MenuCellOpts(cell.FgColor(cell.ColorRed)))
				testdraw.MustMenu(c, "blue", image.Point{0, 2}, draw.MenuCellOpts(cell.FgColor(cell.ColorBlue)))
				testcanvas.MustApply(c, ft)
				return ft
			},
		},
		{
			...
			want: func(size image.Point) *faketerm.Terminal {
				...
				testdraw.MustMenu(c, "hello wor…", image.Point{0, 0})
				testdraw.MustMenu(c, "short", image.Point{0, 1})
				testdraw.MustMenu(c, "exactly 10", image.Point{0, 2})
				testdraw.MustMenu(c, "and long …", image.Point{0, 3})
				testcanvas.MustApply(c, ft)
				return ft
			},
		},
		{
			...
			want: func(size image.Point) *faketerm.Terminal {
				...
				testdraw.MustMenu(c, "hello wor…", image.Point{0, 0})
				testdraw.MustMenu(c, "hello wor…", image.Point{0, 1})
				testdraw.MustMenu(c, "and long …", image.Point{0, 2})
				testcanvas.MustApply(c, ft)
				return ft
			},
		},
		{
			...
			want: func(size image.Point) *faketerm.Terminal {
				...
				testdraw.MustMenu(c, "line0", image.Point{0, 0})
				testdraw.MustMenu(c, "line1", image.Point{0, 1})
				testcanvas.MustApply(c, ft)
				return ft
			},
		},
		{
			...
			want: func(size image.Point) *faketerm.Terminal {
				...
				testdraw.MustMenu(c, "line0", image.Point{0, 0})
				testdraw.MustMenu(c, "line1", image.Point{0, 1})
				testdraw.MustMenu(c, "⇩", image.Point{0, 2})
				testcanvas.MustApply(c, ft)
				return ft
			},
		},
		{
			...
			want: func(size image.Point) *faketerm.Terminal {
				...
				testdraw.MustMenu(c, "⇧", image.Point{0, 0})
				testdraw.MustMenu(c, "line2", image.Point{0, 1})
				testdraw.MustMenu(c, "line3", image.Point{0, 2})
				testcanvas.MustApply(c, ft)
				return ft
			},
		},
		{
			...
			want: func(size image.Point) *faketerm.Terminal {
				...
				testdraw.MustMenu(c, "line1", image.Point{0, 0})
				testdraw.MustMenu(c, "line2", image.Point{0, 1})
				testcanvas.MustApply(c, ft)
				return ft
			},
		...
		},
		{
			...
			want: func(size image.Point) *faketerm.Terminal {
				...
				testdraw.MustMenu(c, "⇧", image.Point{0, 0})
				testdraw.MustMenu(c, "line4", image.Point{0, 1})
				testdraw.MustMenu(c, "⇩", image.Point{0, 2})
				testcanvas.MustApply(c, ft)
				return ft
			},
		...
		},
		{
			...
			want: func(size image.Point) *faketerm.Terminal {
				...
				testdraw.MustMenu(c, "hello worl", image.Point{0, 0})
				testdraw.MustMenu(c, "d", image.Point{0, 1})
				testdraw.MustMenu(c, "short", image.Point{0, 2})
				testdraw.MustMenu(c, "and long a", image.Point{0, 3})
				testdraw.MustMenu(c, "gain", image.Point{0, 4})
				testcanvas.MustApply(c, ft)
				return ft
			},
		},
		{
			...
			want: func(size image.Point) *faketerm.Terminal {
				...
				testdraw.MustMenu(c, "hello wor", image.Point{0, 0})
				testdraw.MustMenu(c, "你", image.Point{0, 1})
				testdraw.MustMenu(c, "hello wor", image.Point{0, 2})
				testdraw.MustMenu(c, "你d", image.Point{0, 3})
				testdraw.MustMenu(c, "and long ", image.Point{0, 4})
				testdraw.MustMenu(c, "世", image.Point{0, 5})
				testcanvas.MustApply(c, ft)
				return ft
			},
		},
		{
			...
			want: func(size image.Point) *faketerm.Terminal {
				...
				testdraw.MustMenu(c, "hello", image.Point{0, 0})
				testdraw.MustMenu(c, "wor你", image.Point{0, 1})
				testdraw.MustMenu(c, "hello", image.Point{0, 2})
				testdraw.MustMenu(c, "wor你d", image.Point{0, 3})
				testdraw.MustMenu(c, "and long", image.Point{0, 4})
				testdraw.MustMenu(c, "世", image.Point{0, 5})
				testcanvas.MustApply(c, ft)
				return ft
		...
		},
		{
			...
			want: func(size image.Point) *faketerm.Terminal {
				...
				testdraw.MustMenu(c, "hello", image.Point{0, 0})
				testdraw.MustMenu(c, "thisisalo-", image.Point{0, 1})
				testdraw.MustMenu(c, "ngword", image.Point{0, 2})
				testdraw.MustMenu(c, "world", image.Point{0, 3})
				testcanvas.MustApply(c, ft)
				return ft
			},
		},
		{
			...
			want: func(size image.Point) *faketerm.Terminal {
				...
				testdraw.MustMenu(c, "short", image.Point{0, 0})
				testdraw.MustMenu(c, "and long …", image.Point{0, 1})
				testcanvas.MustApply(c, ft)
				return ft
			},
		},
		...
		},
		{
			...
			want: func(size image.Point) *faketerm.Terminal {
				...
				testdraw.MustMenu(c, "and long a", image.Point{0, 0})
				testdraw.MustMenu(c, "gain", image.Point{0, 1})
				testcanvas.MustApply(c, ft)
				return ft
			},
		},
