[![Doc Status](https://godoc.org/github.com/joegruffins/termdash?status.png)](https://godoc.org/github.com/joegruffins/termdash)
[![Build Status](https://travis-ci.org/joegruffins/termdash.svg?branch=master)](https://travis-ci.org/joegruffins/termdash)
[![Sourcegraph](https://sourcegraph.com/github.com/joegruffins/termdash/-/badge.svg)](https://sourcegraph.com/github.com/joegruffins/termdash?badge)
[![Coverage Status](https://coveralls.io/repos/github/joegruffins/termdash/badge.svg?branch=master)](https://coveralls.io/github/joegruffins/termdash?branch=master)
[![Go Report Card](https://goreportcard.com/badge/github.com/joegruffins/termdash)](https://goreportcard.com/report/github.com/joegruffins/termdash)
[![License](https://img.shields.io/badge/License-Apache%202.0-blue.svg)](https://github.com/joegruffins/termdash/blob/master/LICENSE)
[![Mentioned in Awesome Go](https://awesome.re/mentioned-badge.svg)](https://github.com/avelino/awesome-go)

# [<img src="./doc/images/termdash.png" alt="termdashlogo" type="image/png" width="30%">](http://github.com/joegruffins/termdash/wiki)
...
[wiki](http://github.com/joegruffins/termdash/wiki).
...
```go
go get -u github.com/joegruffins/termdash
```
...
```go
go run github.com/joegruffins/termdash/termdashdemo/termdashdemo.go
```

# Documentation

Please refer to the [Termdash wiki](http://github.com/joegruffins/termdash/wiki) for
...
```go
go run github.com/joegruffins/termdash/widgets/button/buttondemo/buttondemo.go
```
...
```go
go run github.com/joegruffins/termdash/widgets/textinput/textinputdemo/textinputdemo.go
```
...
```go
go run github.com/joegruffins/termdash/widgets/gauge/gaugedemo/gaugedemo.go
```
...
```go
go run github.com/joegruffins/termdash/widgets/donut/donutdemo/donutdemo.go
```
...
```go
go run github.com/joegruffins/termdash/widgets/text/textdemo/textdemo.go
```
...
```go
go run github.com/joegruffins/termdash/widgets/sparkline/sparklinedemo/sparklinedemo.go
```
...
```go
go run github.com/joegruffins/termdash/widgets/barchart/barchartdemo/barchartdemo.go
```
...
```go
go run github.com/joegruffins/termdash/widgets/linechart/linechartdemo/linechartdemo.go
```
...
```go
go run github.com/joegruffins/termdash/widgets/segmentdisplay/segmentdisplaydemo/segmentdisplaydemo.go
```
